        ...
        <main>
            ...
            {submitted ? (
                <div className="my-10 flex flex-col
                     bg-yellow-500 mx-auto max-w-2xl text-white p-10 ">
                    <h1
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col p-5 my-10 max-w-2xl mx-auto mb-10">
                    ...
                    form-input mt-1 block w-full outline-none 
                    ...
                    <label className="block mb-5">
                        ...
                        <textarea
                            ...
                            className="shadow border rounded py-2 px-3 
                     form-textarea mt-1 block w-full outline-none
                      focus:ring ring-yellow-500"
                            placeholder="Enter a comment" rows={8} />
                    </label>
...
bg-yellow-400 focus:shadow-outlne
focus:outline-none text-white font-bold
py-2 px-4 cursor-pointer rounded" value="Submit" />
                </form>
            )}
            ...
            max-w-2xl mx-auto shadow-yellow-500 shadow space-y-2">
                <h3 className="text-4xl text-center">Comments</h3>
                <hr className="pb-2" />
                {post.comments.map((comment) => (
                    <div>
                        <p><span className="text-yellow-500">{comment.name}: </span>
                            {comment.comment} </p>
                    </div>
                ))}
            </div>
